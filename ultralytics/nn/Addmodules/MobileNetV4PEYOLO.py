...
__all__ = ['MobileNetV4ConvLargePENet', 'MobileNetV4ConvSmallPENet', 'MobileNetV4ConvMediumPENet', 'MobileNetV4HybridMediumPENet', 'MobileNetV4HybridLargePENet']

from ultralytics.nn.Addmodules import PENet
...
def MobileNetV4ConvSmallPENet():
    model = MobileNetV4('MobileNetV4ConvSmall')
    return model

def MobileNetV4ConvMediumPENet():
    model = MobileNetV4('MobileNetV4ConvMedium')
    return model

def MobileNetV4ConvLargePENet():
    model = MobileNetV4('MobileNetV4ConvLarge')
    return model

def MobileNetV4HybridMediumPENet():
    model = MobileNetV4('MobileNetV4HybridMedium')
    return model

def MobileNetV4HybridLargePENet():
...
if __name__ == "__main__":
    ...
    # Model
    model = MobileNetV4ConvSmallPENet()
